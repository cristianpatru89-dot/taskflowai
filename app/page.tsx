...
const toolkits = [
  ...
  { name: "Recruiting", desc: "Job descriptions, interviews, scorecards, offer letters.", tools: 8, price: "$69", icon: "👥", iconBg: "bg-amber-50", priceColor: "text-amber-600", link: "/toolkit/recruiting" },

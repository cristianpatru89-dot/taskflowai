        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-xl">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://taskflowai.lemonsqueezy.com/checkout/buy/94a22882-854b-4aa8-8506-002871cdfeb7" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-gray-900 text-white text-sm font-medium rounded-xl hover:bg-gray-800 transition-colors">
                Unlock Startup Toolkit — $99
              </a>

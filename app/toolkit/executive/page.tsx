          ...
          <div className="lg:sticky lg:top-6 lg:self-start">
            {!activeWorkflow ? (
              ...
              <div className="border border-gray-100 rounded-xl overflow-hidden">
                ...
                <div className="px-5 py-4 space-y-4 border-b border-gray-100 max-h-[50vh] overflow-y-auto">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-xl">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://taskflowai.lemonsqueezy.com/checkout/buy/451c1afc-6c19-4734-adc7-ab1397b81218" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-gray-900 text-white text-sm font-medium rounded-xl hover:bg-gray-800 transition-colors">
                Unlock Executive Toolkit — $149
              </a>

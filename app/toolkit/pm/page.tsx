      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          ...
          <div>
            ...
            <p>I have spent over 6 years as a Product Manager — at AirportLabs building billing systems for airports around the world, at Fortech leading product strategy and AI/ML ideation, and before that in UX and product design. I have facilitated over 50 ideation workshops, built high-fidelity prototypes, written hundreds of PRDs, and managed teams of 7+ PMs and POs.</p>
            <p className="mt-3">And in all of that time, one thing never changed: the most valuable professionals I worked with — lawyers, recruiters, finance leads, clinicians, executives — were spending enormous amounts of their time on tasks that were important but repetitive.</p>
            <p className="mt-3">Not because they were inefficient. But because no one had given them a better way.</p>
          </div>

          <div>
            <h2 className="text-base font-medium text-gray-900 mb-3">What AI changed — and what it did not</h2>
            <p>When large language models became genuinely useful, I was one of the first people in every room I sat in to start experimenting. Not because I was a technologist chasing the next trend — but because I am a product manager, and I recognized a tool that could change the way professionals work.</p>
            <p className="mt-3">But I also noticed something that most people were missing: AI alone does not make you more effective. A blank prompt box is like a blank page — it helps the people who already know what to write. For everyone else, it is just another thing to figure out.</p>
            <p className="mt-3">The professionals who got the most out of AI were not the ones who were the best at prompting. They were the ones who understood their own work deeply enough to direct the AI precisely. The tool amplified their expertise. It did not replace it.</p>
          </div>

          <div>
            <h2 className="text-base font-medium text-gray-900 mb-3">Built with practitioners, not just for them</h2>
            <p>I did not build TaskFlowAI alone, and I did not build it from assumptions.</p>
            <p className="mt-3">Before writing a single workflow, I spent months talking to the professionals who would use it — sitting with lawyers reviewing contracts at midnight, with recruiters drowning in job descriptions, with finance managers wrestling with board decks, with teachers spending their Sundays writing report comments.</p>
            <p className="mt-3">Their answers shaped every workflow in this product. The PM toolkit reflects 6 years of my own experience shipping products. The legal toolkit was validated with practicing lawyers. The healthcare workflows were reviewed with clinicians. The sales sequences were built with people who close deals for a living.</p>
          </div>

          <div>
            <h2 className="text-base font-medium text-gray-900 mb-3">What TaskFlowAI is — and is not</h2>
            <p>TaskFlowAI is not here to replace professionals. It is here to give them back the hours they spend on the parts of their job that are necessary but not where their real value lies.</p>
            <p className="mt-3">Every toolkit in TaskFlowAI is built around one principle: <strong className="font-medium text-gray-900">AI should accelerate your expertise, not substitute for it.</strong> The output of every workflow is a starting point — something you complete, refine, and make your own.</p>
          </div>

          <div>
            <h2 className="text-base font-medium text-gray-900 mb-3">Where we are going</h2>
            <p>We are at the beginning. Twelve toolkits, 120 workflows, and a community of professionals who are finding better ways to work — that is what exists today.</p>
            <p className="mt-3">If you are a professional who has found TaskFlowAI useful — or one who thinks we are missing something important for your field — I want to hear from you.</p>
          </div>

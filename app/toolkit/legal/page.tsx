...
Client level: ${inputs.client_type || '[client level]'}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-xl">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://taskflowai.lemonsqueezy.com/checkout/buy/1a53e01f-79ff-49ea-9ef4-6685877b219e" target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-gray-900 text-white text-sm font-medium rounded-xl hover:bg-gray-800 transition-colors">
                Unlock Legal Toolkit — $129
              </a>
